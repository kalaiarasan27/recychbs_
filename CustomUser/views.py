...
def send_extraData(request):
    try:
        ...
        data.extradata_field1 = if  extra[0] else none
        data.extradata_field3 = if  extra[1] else none
        data.extradata_field3 = if  extra[2] else none
        data.extradata_field4 = if  extra[3] else none
        data.save()
        print("after if")
        return JsonResponse({
